...
(function (Elm) {
    ...
    function fullscreen(module) {
        var style = document.createElement('style');
        style.type = 'text/css';
        style.innerHTML = "html,head,body { padding:0; margin:0; }" + "body { font-family: calibri, helvetica, arial, sans-serif; }";
        document.head.appendChild(style);
        var container = document.createElement('div');
        document.body.appendChild(container);
        return init(ElmRuntime.Display.FULLSCREEN, container, module);
    }
    Elm.fullscreen = fullscreen;

    function embed(module, container) {
    ...
    function init(display, container, module, moduleToReplace) {
        if (typeof moduleToReplace === "undefined") { moduleToReplace = null; }
    ...
    function initGraphics(elm, Module) {
        ...
        var renderer = Elm.A3(Signal.foldp, Elm.F2(domUpdate), currentScene, signalGraph);
