...
export function fullscreen(module) {
...
export function embed(module, container) {
...
export function worker(module) {
    return init(ElmRuntime.Display.NONE, {}, module);
}

function init(display, container, module, moduleToReplace=null) {
