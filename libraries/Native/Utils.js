        ...
        (function (Utils) {
            function make(elm) {
                                        ...
                                        if (n >= 5) {
                                            ...
                                            if (n >= 6) {
                                                ...
                                                if (ord !== EQ)
                                                    return ord;
                                                if (n >= 7)
                                                    throw new Error('Comparison error: ' + err);
                                            }
                                        }
                                    }
                                }
                ...
                function insert(x, v, r) {
                    var o = copy(r);
                    if (x in o)
                        o._[x] = [o[x]].concat(x in o._ ? o._[x].slice(0) : []);
                    o[x] = v;
                    return o;
                }
                ...
                function htmlHeight(width, html) {
                    ...
                    var w = Math.ceil(parseInt(style.getPropertyValue("width").slice(0, -2)) - 0);
                    var h = Math.ceil(parseInt(style.getPropertyValue("height").slice(0, -2)) - 0);
